...
function Hero() {
  ...
  return (
    <div
      className={`h-[92vh] flex flex-col justify-center items-center transition-opacity duration-1000 relative overflow-hidden ${
    ...
    >
      ...
      >
        <div className="font-rubik font-extrabold text-4xl md:text-5xl lg:text-6xl">
          <div className="text-center">
            Hello, I Am{" "}
            <span className="text-rosepine-pine relative inline-block group">
              Faizan Ahmad
          ...
          <motion.div 
            ...
            className="text-rosepine-subtle font-normal text-2xl md:text-3xl lg:text-4xl mt-4"
          >
      ...
      <motion.div 
        ...
        className="flex flex-col md:flex-row gap-8 md:gap-20 lg:gap-80 text-xl font-bold text-rosepine-iris/30 mt-20 md:mt-44"
      >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <motion.div
                  ...
                  role="button"
                  tabIndex={0}
                  className="relative group cursor-pointer transition-all duration-300 hover:translate-y-2 hover:text-rosepine-iris/80 p-4 focus:outline-none focus:ring-2 focus:ring-rosepine-pine rounded-lg"
      ...
      >
        <div className="flex flex-col items-center gap-2 text-rosepine-text/40">
